...
public class Planeta extends Astro {
    ...
    // Constructor
    public Planeta(String nombre, double radio, double rotEje, double masa, double tempMedia, double gravedad, double orbSol, double distSol) {
    ...
    @Override
    public int obtenerNumeroDistanciaSoles() {
        return (int)(distSol / DIAMETRO_SOL);
        //return (int)distSol / DIAMETRO_SOL; //comentar el error que da
