...
public class Utilidades {
    ...
    public static void pintaMenu() {
        ...
        System.out.println("6.- pendiente... consultar por programadores con LP UNDEFINED");
        System.out.println("7.- Informe de programadores menores de 23");
     ...
     */
    public static void darProgramadorAlta(ArrayList<Programador> programadores) throws LimiteEdadException {
        ...
        try{
            ...
            System.out.println("[AVISO] El LP no está soportado. Se va a asignar el lenguaje "+Lenguajes.UNDEFINED);
        ...
        // --------------
        // Antes de dar de alta el programador, verifico su edad
        if (edad >= 18 && edad < 23)
            throw new LimiteEdadException(dni, edad, leng);
