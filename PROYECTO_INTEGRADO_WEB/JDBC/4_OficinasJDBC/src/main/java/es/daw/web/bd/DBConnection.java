...
public class DBConnection {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        if (con == null) {
            ...
            try {
                /*
                Laa inclusión de la línea de código Class.forName con el driver de MySQL es necesaria para cargar 
                el controlador JDBC de MySQL en la memoria del servidor de aplicaciones y 
                establecer la conexión con la base de datos de MySQL, 
                a pesar de que la dependencia del controlador JDBC de MySQL ya está agregada en el archivo pom.xml    */            
